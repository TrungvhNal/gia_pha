...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <!-- Styles -->
        <link rel="stylesheet" type="text/css" href="{!! url("/css/streeadmin.css")!!}">
    </head>
    <body>
    <div class="tree">
        <ul>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <ul>
                                ...
                                <ul>
                                    <li>
                                        <a href="#">
                                            ...
                                            <div><img src="/img/vo.jpg" style="width: 100px; height: 125px"><br><p>Nguyễn Thị Hồng</p></div>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                            ...
                            <li><a href="#">Võ Thị Bình</a></li>
                            <li><a href="#">Võ Thị Châu</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="#">Võ Huy Hữu</a>
                        <ul>
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="#"><img src="/img/hehe.png" style="width: 100px; height: 125px"><br>Vo Huy Trung</a>
                                        <a href="#"><img src="/img/vo.jpg" style="width: 100px; height: 125px"><br>Nguyễn Thị Ánh Hội</a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="/img/hehe.png" style="width: 100px; height: 125px"><br>Vo Thị Mai</a>
                                    </li>
                                </ul>
